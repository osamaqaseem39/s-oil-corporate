export const company = {
  name: "SOIL Lubricants",
  tagline: "Engineered for Performance. Trusted Worldwide.",
  description:
    "SOIL Lubricants is a leading manufacturer of premium motor oils and industrial lubricants, delivering advanced protection and fuel efficiency for passenger cars, commercial fleets, and industrial applications across Pakistan and beyond.",
...
export const visionMission = {
  vision:
    "To be the most trusted lubricants brand in Pakistan and a recognized leader in engine protection technology across emerging markets.",
  mission:
